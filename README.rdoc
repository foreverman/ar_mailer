...
http://github.com/foreverman/ar_mailer/wikis
...
Then
  ...
  $ sudo gem install foreverman-ar_mailer

For Rails >= 2.1, in your environment.rb:

  config.gem "foreverman-ar_mailer", :lib => 'action_mailer/ar_mailer'

  # or since version 2.1.7 of this gem you can now just do

  config.gem "foreverman-ar_mailer"
